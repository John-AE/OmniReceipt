...
const Template9: React.FC<Template9Props> = ({ data }) => {
  ...
  const displayTotal = hasPartialPayments
    ...
    : data.totalAmount;
  const primaryColor = data.primaryColor || "#B31942"; // Default American Red for Template 9
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              {hasPartialPayments ? (
                <>
                  ...
                  <div
                    className="flex justify-between py-2 font-medium border-b border-gray-200"
                    style={{ color: primaryColor }}
                  >
